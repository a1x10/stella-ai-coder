...
- `/дерево` — сразу показать дерево проекта без ожидания модели
- `/список` — сразу показать файлы в папке
- `/обзор` — изучить проект и попросить Stella описать его
- `/найти bot` — найти файлы по имени
- `/поиск TODO` — найти текст внутри файлов
